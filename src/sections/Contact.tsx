...
const quickContacts = [
  { label: 'Telegram (Sofia)', href: 'https://t.me/alienlale', handle: '@alienlale' },
  { label: 'Telegram (Mikhail)', href: 'https://t.me/mishanya_bok', handle: '@mishanya_bok' },
]
    ...
    <section id="contact" className="section-gap container-x">
      ...
      >
        ...
        <div>
          ...
          >
            Tell us about your project — what you need, what you're imagining, and we'll take it from there.
          </motion.p>
          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              >
                ...
                {/* Contact */}
                <div className="relative">
                  <label className="label block mb-2">Contact</label>
                  <input
