      ...
      >
        {processSteps.map((step, i) => (
          <motion.div
            key={step.number}
            variants={fadeUp}
            className="relative pt-8 md:pt-0 md:pr-8"
          >
            ...
            {/* Number */}
            <span className="font-display text-[3rem] italic font-light text-[var(--color-accent)] leading-none block mb-4">
              {step.number}
            </span>
            ...
            <h3 className="font-body font-medium text-[var(--color-white)] mb-2" style={{ fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              {step.title}
            </h3>
