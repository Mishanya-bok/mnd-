...
export const offerings = [
  ...
  { title: 'Одностраничные сайты', line: 'Лендинги под ключ на вайб-кодинге — быстро и без шаблонов.' },
  { title: 'Анимации для сайтов', line: 'Живые веб-анимации и моушн, которые оживляют интерфейс.' },
...
export const achievements = [
  ...
  {
    label: 'Охват',
    title: '10 билбордов Москвы',
    body:
      'Наши работы выходили на 10 крупнейших билбордах Москвы — реклама увидела весь город.',
  },
]
...
export const socialProof = {
  ...
  sub: 'Крупные блогеры и бренды репостят наши работы к себе.',
  stories: [
